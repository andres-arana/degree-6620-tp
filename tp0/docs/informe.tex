...
\begin{description}
  \item[-c] Compila o ensambla el código fuente pero no corre el linker.
Por lo tanto la última salida corresponde a un archivo objeto por cada archivo
fuente.
  \item[-o] Nos permite especificar cual será el archivo de salida sea éste un
archivo objeto, ejecutable, ensamblado o código preprocesado de C.
  \item[-Wall] Activa todos los mensajes de warning.
  \item[-I] Agrega el directorio a la lista de directorios buscados por los 
archivos header\(()*.h)\).
\end{description}

\begin{enumerate}
  \item \(gcc -c -o build/obj/buffer.o source/buffer.c -I./source -Wall\)
  \item \(gcc -c -o build/obj/data.o source/data.c -I./source -Wall\)
  \item \(gcc -c -o build/obj/clargs.o source/clargs.c -I./source -Wall\)
  \item \(gcc -c -o build/obj/cltext.o source/cltext.c -I./source -Wall\)
  \item \(gcc -c -o build/obj/tp0.o source/tp0.c -I./source -Wall\)
  \item \(gcc -c -o build/obj/stooge.o source/stooge.c -I./source -Wall\)
  \item \(gcc -c -o build/obj/quicksort.o source/quicksort.c -I./source -Wall\)
\end{enumerate}
...
\begin{enumerate}
  \item \(gcc -S -o build/asm/buffer.s source/buffer.c\)
  \item \(gcc -S -o build/asm/data.s source/data.c\)
  \item \(gcc -S -o build/asm/clargs.s source/clargs.c\)
  \item \(gcc -S -o build/asm/cltext.s source/cltext.c\)
  \item \(gcc -S -o build/asm/tp0.s source/tp0.c\)
  \item \(gcc -S -o build/asm/stooge.s source/stooge.c\)
  \item \(gcc -S -o build/asm/quicksort.s source/quicksort.c\)
\end{enumerate}
